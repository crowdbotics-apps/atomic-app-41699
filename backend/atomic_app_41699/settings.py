"""
Django settings for atomic_app_41699 project.
...
ROOT_URLCONF = 'atomic_app_41699.urls'
...
WSGI_APPLICATION = 'atomic_app_41699.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "atomic_app_41699 API",
    "DESCRIPTION": "API documentation for atomic_app_41699 App",
    "VERSION": "v1",
}
